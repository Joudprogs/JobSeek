<section class="bg-white">
    <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
      <div class="font-light text-gray-500 sm:text-lg">
        <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900">For Job Seekers</h2>
        <p class="mb-4">
            Show off your skills, projects, and passion. Build a standout profile and find real opportunities that match your goals.      </p>
