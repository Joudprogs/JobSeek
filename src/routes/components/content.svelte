<!-- <section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        <div class="max-w-screen-md mb-8 lg:mb-16">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Why Job Seek ?</h2>
            <p class="text-gray-500 sm:text-xl dark:text-gray-400">At JobSeek, we connect graduates with meaningful opportunities and help employers find top emerging talent. Our platform simplifies the job search and hiring process, empowering both job seekers and employers to succeed.</p>
        </div>
        <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div>
                ...
                <p class="text-gray-500 dark:text-gray-400">Direct employer access</p>
            </div>
            <div>
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <p class="text-gray-500 dark:text-gray-400">Tailored for fresh graduates</p>
            </div>
            <div>
                <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
                ...
                <p class="text-gray-500 dark:text-gray-400">Easy-to-use, modern platform</p>
            </div>
        </div>
    </div>
  </section> -->
